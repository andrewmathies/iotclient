...
class xDot:
    def __init__(self,xDot_serial='COM4',baud=115200):
    ...
    def join_status(self):
        ...
        match = re.compile('1')
        if (xD.send_command("AT+NJS") == True):
            if (match.search(xD.command_return_string)):
                return True
            else:
                return False
        else:
    ...
    def send_message(self, message):
        ...
        #print("original message: ", self.command_return_string)
        ...
        #return bytearray.fromhex(self.command_return_string)
...
if __name__ == "__main__":
    ...
    received_data = xD.send_message("am")
    print(received_data)
    xD.close_port()

# script will
#1. at_Send
#2. on_connect - unpack and increment value
#3. publish down
#4. at_send data, rx of published data, unpack and increment value